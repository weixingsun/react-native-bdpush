...
public class PushModule extends ReactContextBaseJavaModule {
    ...
    //发送透传消息
    public void sendPenetrateMsg(String msg,String custom){
    ...
    //函数执行状态返回
    public void sendState(int status,int msgState,WritableMap msg){
    ...
    public void initialise(){
        Log.d("百度推送", "正在初始化");
        PushSettings.enableDebugMode(getReactApplicationContext(), true);
